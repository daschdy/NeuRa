...
The following chapter summarizes the architecture proposed by Wang and Lu \cite{wang_flexible_2022}.

The proposed NoC architecture in Fig.~\ref{fig:System_Architecture} is designed to support three distinct \ac{Qo}) schemes in order to satisfy the heterogeneous communication requirements of different AXI4 masters and slaves:
